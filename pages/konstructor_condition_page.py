...
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_save as condsave
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_edit as condedit
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_status as condstatus
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_filter_directory as condfildic
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_filter as condfil
from locators.konstructor_condition_locators import Konstructor_Condition_Locators_edits_predict as condedpr
...
class Test_Konstructors_Condition(BasePage):
    ...
    def konstructor_condition_status(self):  #4.Конструктор условий. Перевод в статусы
        ...
        names = self.RandomName("Тест Перевод в статус")
        print(names)
    ...
    def konstructor_condition_filter_directory(self):   #5.Конструктор условий. Фильтрация в качестве справочника
        ...
        self.element_is_visible(condstatus.ADD_STATUS).click()
        names = self.RandomName("Тест Фильтрация в качестве справочника")
        print(names)
    ...
    def konstructor_condition_filter(self):  # 6.Конструктор условий. Фильтрация
        ...
        names = self.RandomName("Тест 5.Фильтрация")
        print(names)
